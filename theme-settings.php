 ...
 */
function sitemade_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['sitemade_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('sitemade sample setting'),
  '#default_value' => theme_get_setting('sitemade_example'),
